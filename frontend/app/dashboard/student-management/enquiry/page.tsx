    ...
    return (
        <div className="space-y-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                <h2 className="text-xl font-bold text-slate-800 mb-4">Enquiry Form Management</h2>
                <p className="text-slate-500 mb-6">Manage all student enquiries here.</p>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-slate-100">
                                ...
                                <th className="py-3 px-4 text-sm font-semibold text-slate-600">Course</th>
